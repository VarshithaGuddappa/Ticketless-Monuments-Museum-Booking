    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Choose Monument/Museum</li>
        ...
        ?>
          ...
          <div class="form-group">
                <label for="exampleInputEmail1">Museum/Monument Name</label>
                <input type="text" value="<?php echo $row->v_name;?>" readonly class="form-control" name="u_car_type">
            </div>
          <!--  <div class="form-group">
